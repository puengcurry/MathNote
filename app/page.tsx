...
import { uploadImage, PRESET_TAGS } from '@/lib/notes'
import TagEditor from '@/components/TagEditor'

const INPUT = 'flex-1 min-w-0 h-11 px-4 text-sm bg-[#fafafa] border border-[#e4e4e4] rounded-xl outline-none focus:border-gray-400 transition-colors placeholder:text-gray-300'
